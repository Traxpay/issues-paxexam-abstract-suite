...
import org.ops4j.pax.exam.junit.impl.TraxpayProbeRunner;
import org.ops4j.pax.exam.spi.reactors.ReactorManager;


/* Copy paste of the PaxExam (4.11.0), see abstract-suite test.
 * Instantiates a TraxpayProbeRunner instead of the ordinary ProbeRunner.
 */
 ...
 */
public class TraxpayPaxExam extends Runner implements Filterable, Sortable {

    private ParentRunner<?> delegate;
    private Class<?> testClass;

    public TraxpayPaxExam(Class<?> klass) throws InitializationError {
    ...
    private void createDelegate() throws InitializationError {
        ...
        if (manager.getSystemType().equals(Constants.EXAM_SYSTEM_CDI)) {
            ...
            delegate = new TraxpayProbeRunner(testClass);
        }
    }
